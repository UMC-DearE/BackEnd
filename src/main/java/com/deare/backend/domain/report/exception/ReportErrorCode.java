...
public enum ReportErrorCode implements BaseErrorCode {
    ...
    REPORT_ANALYSIS_NOT_ENOUGH_NEW_LETTERS(HttpStatus.BAD_REQUEST, "REPORT_40002", "새 편지 3통이 필요해요."),
    REPORT_ANALYSIS_WEEKLY_LIMIT(HttpStatus.BAD_REQUEST, "REPORT_40003", "매주 월요일 분석이 초기화돼요."),
